...
#define OS_TICKS_PER_SECOND CONFIG_TICKS_PER_SECOND
#else
#define OS_TICKS_PER_SECOND 100
#endif

#if (OS_TICKS_PER_SECOND > 1000) || (OS_TICKS_PER_SECOND == 0)
#error "config ticks range in [1~1000]"
#endif

#define TICKS_PER_MILLISECOND (1000 / OS_TICKS_PER_SECOND)
